...
<html lang="zxx">
	...
	<!-- Navbar Area End -->
        ...
        <!-- Page Title Start -->
        <section class="page-title title-bg13" style="background-image: url(assets/img/title-bg/7.png)">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2>Sign Up</h2>
                    <ul>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-3">
                        <form class="signup-form" action="usercontroller" method="POST">
	                        <input type="hidden" value="sign_up" name="actionType">
	                        	<div class="row">
	                        		<div class="form-group">
		                                <label>Enter Name</label>
		                                <input type="text" class="form-control" name="username" placeholder=" Your Name" required  style="width: 530px;">
		                            </div>
                                    ...
                                    <div class="col-md-6">
			                            ...
			                            <select class="form-control" name="role" required>
		                                    ...
		                                    <option data-display="Job Seeker" >Job Seeker</option>
