					...
					<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
						<ul class="navbar-nav m-auto">
							...
							<li class="nav-item">
								...
								<ul class="dropdown-menu">
									<li class="nav-item">
										<a href="sign-in.jsp" class="nav-link">Find A Job</a>
									</li>
									<li class="nav-item">
										<a href="sign-in.jsp" class="nav-link">Post A Job</a>
									</li>
									<li class="nav-item">
							...
							<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="our-team.jsp" class="nav-link">Candidates Details</a>
										</li>
									</ul>
								</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item">
										<a href="our-team.jsp" class="nav-link">Our Team</a>
									</li>
									<li class="nav-item">
							...
							<li class="nav-item">
								<a href="sign-in.jsp" class="nav-link">Contact Us</a>
							</li>
						</ul>
			...
			<div class="condidate-slider owl-carousel owl-theme">
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Ajay Pratap</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Manager
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Sachin Gurav</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								UI/UX Designer
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Nitesh Thakare</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Web Developer
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Samar Waris</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Video Designer
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Pooja Tawade</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Graphic Designer
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Atharv Patole</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Digital Marketing
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Devyani Rathod</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Video Editor
				...
				<div class="condidate-item">
					...
					<div class="candidate-text">
						<h3><a href="our-team.jsp">Avnish Karwa</a></h3>
						<ul>
							<li>
								<i class='bx bx-filter-alt'></i>
								Content Writer
