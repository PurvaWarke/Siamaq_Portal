...
<html lang="zxx">
	...
	<!-- Navbar Area End -->
        ...
        <!-- Page Title Start -->
        <!-- <section class="page-title title-bg6" style="background-image: url(assets/img/title-bg/14.png)">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2>Job Details</h2>
                    <ul>
                            ...
                            <div class="col-lg-12">
                                <div class="job-details-text">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-2">
                                                <div class="company-logo">
                                                    <img src="assets/img/find-job/1.jpg" alt="logo">
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="job-info">
                                    ...
                                    <div class="details-text">
                                        <h3>Description</h3>
                                        <p>Must be able to conceptualize and design visual assets for advertising campaigns, including print ads, digital ads, social media graphics, billboards, packaging, and other promotional materials.
											Must be able to collaborate and develop innovative and visually impactful concepts to meet the client's needs
											Will have to participate in client meetings and presentations
											Will have to collaborate with external vendors, such as printers and photographers, to ensure accurate production and high-quality outputs.
											Must maintain brand consistency across all design materials
											</p>

                                        <p>Keep up-to-date with the latest design trends, tools, and technologies
											Identify the best ways to illustrate and communicate client's vision while complying with best design practices
 										</div>
                                    ...
                                    <div class="details-text">
                                       ...
                                       <p> </p>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <i class='bx bx-check'></i>
                                               Create compelling and effective digital media posts, designs & print .
                                            </li>
                                            <li>
                                                <i class='bx bx-check'></i>
                                            ...
                                            <li>
                                                <i class='bx bx-check'></i>
                                                Use industry-standard design software and tools to execute designs efficiently.
                                            </li>
                                            <li>
                                                <i class='bx bx-check'></i>
                                                 Conduct research and stay up-to-date with design trends to continually improve skills and knowledge.
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="mailto:siamaq@portal.com">hr@edufund.gmail.com</a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>40000-50000 Rs</td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>Website</span></td>
                                                            <td><a href="#">www.edufund .com</a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                    ...
                                    <div class="theme-btn">
                                        <a href="apply.jsp" class="default-btn">
                                            Apply Now
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="job-sidebar">
                            ...
                            <div class="posted-by">
                                ...
                                <h4>Sanjay Kumar</h4>
                                <span>HR of Edufund Pvt.Ltd.</span>
                            </div>
                        </div>

                         <div class="job-sidebar">
                            <h3>Location</h3>
                            <iframe src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=baner , pune&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" frameborder="0"></iframe>
                        </div>
                        <div class="job-sidebar">
                            <h3>Keywords</h3>
                            <ul>
                                ...
                                <li>
                                    <a href="#">Animation Design</a>
                                </li>
                                <li>
                                    <a href="#">App Designing</a>
                                </li>
                                <li>
                                    <a href="#">Graphics</a>
                                </li>
        ...
        <section class="job-style-two pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <p>Explore diverse industries and job roles, from established companies to startups. Whether you're a seasoned professional or just starting your career, you'll find a variety of opportunities to explore.</p>
                </div>
                        ...
                        <div class="job-card-two">
                            <div class="row align-items-center">
                                <div class="col-md-1">
                                    <div class="company-logo">
                                        <a href="job-details.jsp">
                                            <img src="assets/img/find-job/7.jpg" alt="logo">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="job-card-two">
                            <div class="row align-items-center">
                                <div class="col-md-1">
                                    <div class="company-logo">
                                        <a href="job-details.jsp">
                                            <img src="assets/img/find-job/6.jpg" alt="logo">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="job-card-two">
                            <div class="row align-items-center">
                                <div class="col-md-1">
                                    <div class="company-logo">
                                        <a href="job-details.jsp">
                                            <img src="assets/img/find-job/4.jpg" alt="logo">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="job-card-two">
                            <div class="row align-items-center">
                                <div class="col-md-1">
                                    <div class="company-logo">
                                        <a href="job-details.jsp">
                                            <img src="assets/img/find-job/9.jpg" alt="logo">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-8">
