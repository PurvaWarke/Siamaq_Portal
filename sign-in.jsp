...
<html lang="zxx">
	...
	<!-- Navbar Area End -->
        ...
        <!-- Page Title Start -->
        <section class="page-title title-bg12" style="background-image: url(assets/img/title-bg/8.png)">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2 >Sign In</h2>
                    <ul>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-3">
                        <form class="signin-form">
                            ...
                            <span id="msgErrorId" style="padding-bottom: 30px;
    						text-align: center;display: none;color: red;">Please enter valid credentials</span>
                              <label>Enter Email</label>
                              <input type="email"  id="email_id" class="form-control" placeholder="Enter Your Email" required>
                            </div>

                            <div class="form-group">
                                <label>Enter Password</label>
                                <input type="password"  id="password_id" class="form-control" placeholder="Enter Your Password" required>
                            </div>
							<div >
                            ...
                            <div class="signin-btn text-center">
                                <button type="button" onclick="return signin();">Sign In</button>
                            </div>
        ...
        <section class="subscribe-section">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <form class="newsletter-form" action="subcontroller" data-toggle="validator">
	...
	<!-- Footer Section End -->
		...
		function signin(){
			...
			$.ajax({
				url : "usercontroller?actionType=sign_in",
				method : 'POST',
				data : {
					email : $('#email_id').val(),
				...
				success : function(resp) {
					...
					if(resp == 0){
						...
						$('#msgErrorId').css('display','none'); 
						window.location.href = '<%=request.getContextPath()%>'+"/login-home.jsp";
//	 					window.href = "/login-home.jsp";
					}
