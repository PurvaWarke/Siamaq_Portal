...
<html lang="zxx">
	...
	<!-- Navbar Area End -->
        ...
        <!-- Page Title Start -->
        <section class="page-title title-bg10" style="background-image: url(assets/img/title-bg/11.png)">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2>Account</h2>
                    <ul>
                    ...
                    <div class="col-md-4">
                        <div class="account-information">
                            <div class="profile-thumb">
                                <img src="assets/img/account.png" alt="account holder image">
                                <h3>Purva Warke</h3>
                                <p>Web Developer</p>
                            </div>
                        ...
                        <div class="account-details">
                            ...
                            <form class="basic-info">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="editable-content">
                                            <label>Current Job Title</label>
                                            <input type="text" class="form-control" placeholder="Current Job Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" >
                                        ...
                                        <span class="popuptext" id="myPopup">Information Saved ! </span>
                                        	<div class="account-btn" >Save</div>
