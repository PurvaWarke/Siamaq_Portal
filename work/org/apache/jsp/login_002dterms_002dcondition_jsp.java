 ...
 * Generated at: 2023-05-29 14:51:31 UTC
...
public final class login_002dterms_002dcondition_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <section class=\"page-title title-bg19\" style=\"background-image: url(assets/img/title-bg/12.png)\">\r\n");
      out.write("            <div class=\"d-table\">\r\n");
      out.write("                <div class=\"d-table-cell\">\r\n");
      ...
      out.write("\r\n");
      out.write("        <!-- Terms Section Start -->\r\n");
      out.write("        <div class=\"terms-section pt-100 pb-100\">\r\n");
      out.write("            <div class=\"container\">\r\n");
      out.write("                <div class=\"terms-text\">\r\n");
      out.write("                    <h2>Siamaq Portal Terms of Service</h2>\r\n");
      out.write("\r\n");
      out.write("                    <h3>1. Terms</h3>\r\n");
      out.write("                    <p>By accessing the website you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</p>\r\n");
      out.write("\r\n");
      out.write("                    <h3>2. Limitations</h3>\r\n");
      out.write("                    <p>In no event shall Fixa or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Fixa's website, even if Fixa or a Fixa authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p>\r\n");
      out.write("\r\n");
      out.write("                    <h3>3. Using the Site and Services</h3>\r\n");
      out.write("                    <p>You may be able to view portions of the Site without registering with Ladders as a registered user. However, in order to access certain password-restricted areas of the Site and to use certain Services and Materials offered on and through the Site you must register at the Site for an account and receive a password, and must also choose a membership level (see âMembershipsâ section below for more information). You can register with us at the Site. Once you have registered, your username and password can be used at the Site. Please note that the Services available to you may also vary depending upon your Membership level.</p>\r\n");
      out.write("\r\n");
      out.write("                    <h3>4. Eligibility</h3>\r\n");
      out.write("                    <p>Users must be at least the age of majority in the jurisdiction in which you reside in order to use the Site and the Services. By using the Site or the Services, you represent, acknowledge and agree that you are at least the age of majority in the jurisdiction where you reside and have the right, authority and capacity to agree to and abide by these Terms.\r\n");
      out.write("						You also represent that you will use the Site and Services in a manner consistent with any and all applicable laws and regulations.\r\n");
      out.write("						Not all products and services are available in all geographic areas. Your eligibility for particular products and services is subject to final determination by Ladders and/or its affiliates.\r\n");
      out.write("						Ladders may terminate these Terms and your use of the Site and Services without notice if we, in our sole discretion, believe that you are not at least the age of majority in the jurisdiction where you reside, or have otherwise violated the Terms.</p>\r\n");
      out.write("\r\n");
      out.write("                    <h3>5. Modifications</h3>\r\n");
      out.write("                    <p>We may update these Terms from time to time. We will give you notice of the changes by posting an updated version of these Terms online, updating the âRevisedâ date above, or by emailing you at an email address you have provided. Changes to these Terms will be effective as of the date we post them or otherwise notify you of them, unless we specify a different effective date when we make a particular change. Your continued use of the Services will constitute your acceptance of the changes. If you do not agree to a change, you must stop using the Services.\r\n");
      out.write("\r\n");
      out.write("We may modify, add to, suspend, or discontinue the Services or certain features of the Services, or remove any Content at any time for any reason, without prior notice to you. Unless expressly stated otherwise, any new feature that augments, enhances, or otherwise modifies the Services is subject to these Terms.</p>\r\n");
      out.write("\r\n");
      out.write("                    <h3>6. Job Applications</h3>\r\n");
      out.write("                    <p>The Muse allows you to get an inside look at employers, browse open positions, and apply to jobs. Some job postings on our Website allow users who are logged into their Muse Accounts to complete and submit job applications directly through our Website. Other job postings on our Website will re-direct you to the applicable employerâs career page, where you will be able to submit an application without creating a Muse Account. Additionally, we may, but are not obligated to, provide your Muse Account with the option to save information for applying to jobs, such as a favorites list of employers, job openings to apply to later, and uploading a resume, cover letter, or other professional information. The collection of any such information is governed by our Privacy Policy.</p>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <!-- Terms Section End -->\r\n");
      out.write("\r\n");
