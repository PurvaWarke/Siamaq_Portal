...
<html lang="zxx">
	...
	<!-- Navbar Area End -->
        ...
        <!-- Page Title Start -->
        <section class="page-title title-bg23" style="background-image: url(assets/img/title-bg/4.png)">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2>Contact Us</h2>
                    <ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="contact-card">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="mailto:info@siamaqsystem.com">
                            ...
                            <div class="col-md-4 col-sm-6 offset-sm-3 offset-md-0">
                                <div class="contact-card">
                                    ...
                                    <ul>
                                        <li>
                                            R.H. N0 : 15, Ujjwal Regalia Society,
                ...
                <div class="contact-area">
                    ...
                    <form id="contactForm">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="subject" id="subject" class="form-control" required data-error="Please enter your city" placeholder="Your City">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
