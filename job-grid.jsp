						...
						<div class="job-card">
							<div class="row align-items-center">
								...
								<div class="col-lg-6">
									<div class="job-info">
										<h3>
											<a href="job-details.jsp">Post-Room Operate</a>
										</h3>
										<ul>
					...
					<div class="col-md-6">
						<div class="job-card">
							...
							<div class="col-lg-6">
								<div class="job-info">
									<h3>
										<a href="job-details.jsp">Data Entry</a>
									</h3>
									<ul>
						...
						<div class="job-card">
							<div class="row align-items-center">
								...
								<div class="col-lg-6">
									<div class="job-info">
										<h3>
											<a href="job-details.jsp">Digital Marketor</a>
										</h3>
										<ul>
						...
						<div class="job-card">
							<div class="row align-items-center">
								...
								<div class="col-lg-6">
									<div class="job-info">
										<h3>
											<a href="job-details.jsp">Accountants</a>
										</h3>
										<ul>
											<li>Via <a href="#">Tourt Design LTD</a></li>
											<li>
					...
					<div class="col-md-6">
						<div class="job-card">
							...
							<div class="col-lg-6">
								<div class="job-info">
									<h3>
										<a href="job-details.jsp">Budget Analysts</a>
									</h3>
									<ul>
										<li>Via <a href="#">Techno Inc.</a></li>
										<li>
