...
<html lang="zxx">
	...
	<!-- Navbar Area End -->
        ...
        <!-- Page Title Start -->
        <section class="page-title title-bg7" style="background-image: url(assets/img/title-bg/3.png)">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2>Our Team</h2>
                    <ul>
	...
	<div class="testimonial-style-two">
		<div class="container">
			<div class="section-title text-center">
				<h2>Meet Our Expert Team at Siamaq Consultancy</h2>
				<p>Our team is dedicated to delivering tangible results. 
				We are proactive problem-solvers, always ready to tackle complex challenges head-on.
				We combine analytical rigor with creativity to 
				develop innovative solutions that create value for our clients.</p>
			</div>
		</div>
	</div>
	
        <!-- Candidates Section Start -->
        <section class="candidate-style-two pb-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Mibraj Alex</a>
                                </h3>
                                <ul>
                                    <li>
                                    Web Developer
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Felica Kareon</a>
                                </h3>
                                <ul>
                                    <li>
                                        PHP Developer
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Malisa Petel</a>
                                </h3>
                                <ul>
                                    <li>
                                        Business Consultant
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Quence Joes</a>
                                </h3>
                                <ul>
                                    <li>
                                        Graphics Designer
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Mary Mainor</a>
                                </h3>
                                <ul>
                                    <li>
                                        Technical Writter
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Jack Hallock</a>
                                </h3>
                                <ul>
                                    <li>
                                        Marketing Expert
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Lucas Mason</a>
                                </h3>
                                <ul>
                                    <li>
                                        UX Designer
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="candidate-card">
                            ...
                            <div class="candidate-text">
                                <h3>
                                    <a href="our-team.jsp">Jerry Hudson</a>
                                </h3>
                                <ul>
                                    <li>
                                        Video Editor
